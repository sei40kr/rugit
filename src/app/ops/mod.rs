...
//! magit-commit.el / magit-branch.el / magit-push.el. Adding a menu (rebase,
//! stash, ...) means: a `TransientDef` + `menu_def` arm in `ui/transient.rs`,
...
use crate::ui::transient::{menu_def, TransientAction, TransientState, MERGE_IN_PROGRESS};
